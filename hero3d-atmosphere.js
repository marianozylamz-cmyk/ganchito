/* =========================================================
   ...
   hero3d-atmosphere.js
   Fragmentos de mosaico flotando de fondo — le dan profundidad y vida
   a la escena sin competir con la mesa (protagonista absoluta). Copia
   directa de experimental-3d/hero-atmosphere.js. Respeta
   prefers-reduced-motion: quedan quietos, no flotan.
   ========================================================= */
...
window.HeroAtmosphere = (function () {
  ...
  // Mismos colores que la paleta de selección — la atmósfera "sugiere"
